namespace JWTMaker
{
    ...
    {
        public Dictionary<JwtHashAlgorithm, Func<byte[], byte[], byte[]>> HashAlgorithms;

        public CustomJWTToken()
        {
        ...
        public string Decode(string token, byte[] keyBytes, bool verify)
        {
        ...
        public string Decode(string token, string key, bool verify)
        {
            ...
            return Decode(token, keyBytes, verify);
        }
